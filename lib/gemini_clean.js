...
- seo_title: Идеальный SEO-заголовок (КРИТИЧЕСКОЕ ТРЕБОВАНИЕ: СТРОГО от 30 до 75 символов!). Обязательно включи код, марку, модель. ПРАВИЛО УНИКАЛЬНОСТИ: ЗАПРЕЩЕНО начинать заголовок со слова "Ошибка". Начинай с названия детали, симптома или марки авто (например: "Клапан фазорегулятора VVT (P0010) на Chevrolet Cobalt"). КАТЕГОРИЧЕСКИ ЗАПРЕЩАЮ использовать слова: ремонт, своими руками, причин, диагностик, проблем, устранени, исправить, что значит. ИСПОЛЬЗУЙ живой авто-сленг, если уместно.
- description_char_count: Посчитай точное количество символов в описании, которое ты напишешь.
- seo_description: Идеальное SEO-описание (КРИТИЧЕСКОЕ ТРЕБОВАНИЕ: СТРОГО от 120 до 160 символов, плотно!). Укажи суть ошибки на ${displayBrand} ${displayModel} и 1-2 конкретных узла, которые вызывают проблему. Без воды и шаблонных вопросов. КАТЕГОРИЧЕСКИ ЗАПРЕЩАЮ использовать слова: ремонт, своими руками, причин, диагностик, проблем, устранени, исправить, что значит.`;
