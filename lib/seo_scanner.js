  ...
  if (prisma) {
    try {
      ...
      if (exactMetaDuplicate) {
        ...
        } else if (uniquenessScore < 15) {
          details.push({ label: "Уникальность текста", score: uPoints, max: 25, status: "warning", text: `Уникальность ${uniquenessScore}%. Допустимая норма для технического контента.` });
        } else {
