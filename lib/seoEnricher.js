...
export function enrichReportText(text, brand, model, code, drivability) {
    ...
    if (dictionaryTerms.length > 0) {
        const dictSection = `\n\n<!-- GLOSSARY_START -->
<div class="not-prose my-8 bg-white dark:bg-slate-800 rounded-2xl border-[1.5px] border-[#0077FF] p-5 shadow-[0_4px_20px_-4px_rgba(0,119,255,0.15)] dark:shadow-[0_4px_20px_-4px_rgba(0,119,255,0.25)] relative overflow-hidden group">
  <div class="absolute inset-0 bg-gradient-to-br from-[#0077FF]/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none"></div>
