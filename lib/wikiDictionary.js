export const wikiDictionary = [
    ...
    { name: 'VR-двигатель (смещенно-рядный)', regex: /(?<![\p{L}\p{N}_])(VR6|смещенно-рядн[а-я]+ двигател[ьа-я]*)(?![\p{L}\p{N}_])/ui, url: 'https://ru.wikipedia.org/wiki/VR-образный_двигатель' },
    ...
    { name: 'Подвеска Макферсон', regex: /(?<![\p{L}\p{N}_])(Макферсон|MacPherson)(?![\p{L}\p{N}_])/ui, url: 'https://ru.wikipedia.org/wiki/Макферсон_(подвеска)' },
    ...
    { name: 'ЭБУ — Электронный блок управления', regex: /(?<![\p{L}\p{N}_])(ЭБУ|ECU|электронн[а-я]+ блок[а-я]* управления|PCM)(?![\p{L}\p{N}_])/ui, url: 'https://ru.wikipedia.org/wiki/Электронный_блок_управления' },
