...
4. new_seo_title: Кликабельный SEO-заголовок (до 75 символов), содержащий марку и код.
5. new_seo_description: SEO-описание (до 155 символов), призывающее прочитать статью, содержащее марку, модель и суть проблемы.
    `.trim();
