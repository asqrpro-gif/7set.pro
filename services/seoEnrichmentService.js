...
СТРОГОЕ ПРАВИЛО: КАТЕГОРИЧЕСКИ ЗАПРЕЩАЮ ИСПОЛЬЗОВАТЬ списки (никаких "-" или "1."). Вместо списков используй жирные заголовки абзацев вида **Совет 1. Название совета**, после которого идет обычный абзац текста.
