...
4. new_seo_description: SEO-описание (КРИТИЧЕСКОЕ ТРЕБОВАНИЕ: СТРОГО от 120 до 160 символов, ни символом больше или меньше!). КАТЕГОРИЧЕСКИ ЗАПРЕЩАЮ использовать слова: ремонт, своими руками, причин, диагностик, проблем, устранени, исправить, что значит.
          `.trim();
